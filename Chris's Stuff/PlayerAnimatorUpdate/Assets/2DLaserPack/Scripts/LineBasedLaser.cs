...
namespace TwoDLaserPack
{
    public class LineBasedLaser : MonoBehaviour
    {
                ...
                if (laserActive)
                {
                    ...
                    if (laserRotationEnabled && targetGo != null)
                    {
                        ...
                        if (lerpLaserRotation)
                        {
                            ...
                            hit = Physics2D.Raycast(this.transform.position, targetForward, maxLaserRaycastDistance);
                        }
                        else
                        {
                            ...
                            hit = Physics2D.Raycast(this.transform.position, facingDirection, maxLaserRaycastDistance);
                        }
                    }
                    else
                    {
                        // Raycast down our transform right vector direction
                        hit = Physics2D.Raycast(this.transform.position, transform.right, maxLaserRaycastDistance);
                    }
        ...
        public void SetLaserState(bool enabledStatus)
        {
            ...
            if (hitSparkParticleSystem != null) hitSparkParticleSystem.enableEmission = enabledStatus;
        ...
        private void SetLaserEndToTargetLocation(RaycastHit2D hit)
        {
            ...
            if (hitSparkParticleSystem != null)
            {
                ...
                hitSparkParticleSystem.enableEmission = true;
            }
        }
        ...
        private void SetLaserToDefaultLength()
        {
            ...
            if (hitSparkParticleSystem != null)
            {
                hitSparkParticleSystem.enableEmission = false;
